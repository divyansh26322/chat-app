...
const registerController = async (req, res) => {
 ...
 return res.status(400).send({message: "A verification link has been already sent to you email." });
 }
 ...
 await user.save();
 res
 .status(201).send({ message: `Verification Email Sent to ${user.email}`,
 });
 } catch (error) {
